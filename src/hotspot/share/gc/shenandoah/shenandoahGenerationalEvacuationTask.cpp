...
void ShenandoahGenerationalEvacuationTask::do_work() const {
...
void ShenandoahGenerationalEvacuationTask::promote_regions() const {
...
void ShenandoahGenerationalEvacuationTask::evacuate_and_promote_regions() const {
  LogTarget(Debug, gc) lt;
  ShenandoahInPlacePromoter promoter(_heap);
