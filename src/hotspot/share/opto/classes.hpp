...
#endif
shmacro(XenandoahCompareAndExchangeP)
shmacro(XenandoahCompareAndExchangeN)
shmacro(XenandoahCompareAndSwapN)
shmacro(XenandoahCompareAndSwapP)
shmacro(XenandoahWeakCompareAndSwapN)
shmacro(XenandoahWeakCompareAndSwapP)
shmacro(XenandoahIUBarrier)
shmacro(XenandoahLoadReferenceBarrier)
macro(SCMemProj)
macro(CopySignD)
macro(CopySignF)
macro(SignumD)
